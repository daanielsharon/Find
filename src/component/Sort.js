	...
	return (
		<div className="w-full desktop:border-solid desktop:border-b-2 desktop:border-indigo-600 tablet:border-solid tablet:border-b-2 tablet:border-indigo-600 desktop:ml-5 tablet:ml-5 mobile:ml-0 mobile:flex mobile:flex-row mobile:items-center mobile:justify-between">
			...
			<select
				...
				className="text-center bg-white desktop:p-[10px] desktop:border-none desktop:ml-0 desktop:w-auto desktop:mt-0 desktop:pb-3 tablet:mt-0 tablet:w-auto tablet:ml-0 tablet:border-none tablet:p-[10px] mobile:p-[10px] mobile:border-solid mobile:border-b-2 mobile:border-indigo-600 mobile:w-4/12 "
				onChange={onSelect}
			>
